...
//_________________________________________________________
    public static final String PIZZA_MARGHUERITA_4_NAME = "Pizza Margherita in 4 easy steps";
    public static final String PIZZA_MARGHUERITA_4_DESCRIPTION = "Even a novice cook can master the art of pizza with our simple step-by-step guide. Bellissimo";
    public static final String PIZZA_MARGHUERITA_4_RECIPE = "Make the base: Put the flour into a large bowl, then stir in the yeast and salt. Make a well, pour in 200ml warm water and the olive oil and bring together with a wooden spoon until you have a soft, fairly wet dough. Turn onto a lightly floured surface and knead for 5 mins until smooth. Cover with a tea towel and set aside. You can leave the dough to rise if you like, but it’s not essential for a thin crust.\n" +
            "\n" +
    ...
    //_________________________________________________________
    public static final String PIZZA_SUPERHEALTHY_NAME = "Superhealthy pizza";
    public static final String PIZZA_SUPERHEALTHY_DESCRIPTION = "The quantities for this are generous, so if you have any leftovers, pop a wedge of cold pizza into your lunchbox the next day";
    public static final String PIZZA_SUPERHEALTHY_RECIPE = "Mix the flours and yeast with a pinch of salt in a food processor fitted with a dough blade. Pour in the water and mix to a soft dough, then work for 1 min. Remove the dough and roll out on a lightly floured surface to a round about 30cm across. Lift onto an oiled baking sheet.\n" +
            "\n" +
